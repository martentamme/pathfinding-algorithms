...
class A_star:
    ...
    def run_algorithm(self):
        ...
        # Add starting point
        # PriorityQueue: (priority, coordinates)
        ...
        while not queue.empty():
            ...
            for neighbour in neighbours:
                ...
                # unless we can reach visited neighbors with less cost
                if neighbour not in came_from or new_cost < cost_so_far[neighbour]:
                    priority = Helper.manhattan_heuristic(neighbour, self.goal) + new_cost
...
if __name__ == '__main__':
    ...
    search = A_star(
        ...
        result_filename="test_map_astar"
    )
